 ...
 * into account an optional user-configured ui scale as well as the global
 ...
 */
@Composable
fun DensityDimension(width: Int, height: Int, userUiScale: Float?): Dimension {
    return DensityDimension(width, height, userUiScale ?: GlobalDensity)
}
